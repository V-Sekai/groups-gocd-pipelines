...
local platform_info_dict = {
  windows: {
    ...
    godot_scons_arguments: "use_mingw=yes use_llvm=yes use_thinlto=no LINKFLAGS=-Wl,-pdb= CCFLAGS='-Wno-tautological-compare -g -gcodeview' debug_symbols=no",
    extra_commands: [],
...
// STERN FLOWERS
local godot_template_stern_flowers_editor = 'godot-template-stern-flowers-4-0';
local godot_template_stern_flowers_export = 'stern-flowers-editor-4-0';
// END
