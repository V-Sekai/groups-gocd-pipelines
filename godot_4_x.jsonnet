...
local platform_info_dict = {
  windows: {
    ...
    godot_scons_arguments: "float=64 use_mingw=yes use_llvm=yes use_thinlto=yes LINKFLAGS=-Wl,-pdb= CCFLAGS='-g -gcodeview' debug_symbols=no",
    extra_commands: [],
  ...
  linux: {
    ...
    godot_scons_arguments: 'float=64 use_static_cpp=yes use_llvm=yes builtin_freetype=yes',
    extra_commands: [],
    environment_variables: [],
    template_artifacts_override: null,
    template_output_artifacts: null,
  ...
  macos: {
    ...
    godot_scons_arguments: 'float=64 osxcross_sdk=darwin19 CXXFLAGS="-Wno-deprecated-declarations -Wno-error " builtin_freetype=yes use_static_mvk=yes',
    extra_commands: [
