local platform_info_dict_4_x = {
  ...
  macos: {
    ...
    template_extra_commands: [
      ...
      'mv ./bin/godot.osx.opt.tools.64 ./bin/osx_template.app/Contents/MacOS/godot_osx_debug.64',
      'chmod +x ./bin/osx_template.app/Contents/MacOS/godot_osx_debug.64',
      'mv ./bin/godot.osx.opt.tools.64 ./bin/osx_template.app/Contents/MacOS/godot_osx_release.64',
