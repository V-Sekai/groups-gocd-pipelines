local platform_info_dict_4_x = {
  ...
  macos: {
    ...
    template_extra_commands: [
      ...
      'cp ./bin/godot.osx.opt.tools.64 ./bin/osx_template.app/Contents/MacOS/godot_osx_debug.64',
      'chmod +x ./bin/osx_template.app/Contents/MacOS/godot_osx_debug.64',
      'cp ./bin/godot.osx.opt.tools.64 ./bin/osx_template.app/Contents/MacOS/godot_osx_release.64',
...
// END
local itch_fire_template = [godot_template_groups_editor_4_x] + [godot_template_groups_export_4_x] + [godot_template_hop_skip_dance_export] + [godot_template_purple_gold_spitz_export] + [godot_template_blue_steel_wolf_export] + [godot_template_hop_skip_dance_export_macos];
