  ...
  )::
    {
      ...
      materials: [
      ...
      ] + [
        {
          ...
          stage: 'gdextension-build-stage-' + library_info.platform_name,
          ignore_for_scheduling: false,
        }
              ...
              tasks: [
                {
                  ...
                  pipeline: pipeline_dependency,
                  stage: 'template-zip-stage-' + export_info.platform_name,
                  job: 'defaultJob',
                ...
                },
                {
                  ...
                  artifact_origin: 'gocd',
                  pipeline: pipeline_dependency,
                  stage: 'default-stage-' + export_info.platform_name,
                  job: 'linux_job',
                  is_source_a_file: true,
                ...
                },
                {
                  ...
                  destination: '',
              ...
              ] + std.flatMap(function(library_info) [
                                {
                                  ...
                                  artifact_origin: 'gocd',
                                  pipeline: library_info.pipeline_name,
                                  stage: 'gdextension-build-stage-' + library_info.name,
              ...
              tasks: [
                {
                  ...
                  stage: 'export-stage-' + export_info.export_name,
  ...
  )::
    {
      ...
      materials: [
        ...
        },
        {
          ...
          type: 'dependency',
          pipeline: pipeline_dependency,
          stage: 'export-stage-' + pipeline_dependency,
          ignore_for_scheduling: false,
        },
      ],
      stages: [
