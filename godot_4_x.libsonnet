local platform_info_dict = {
  ...
  macos: {
    ...
    extra_commands: [
      'OSXCROSS_ROOT="LD_LIBRARY_PATH=/opt/osxcross/target/bin /opt/osxcross" scons platform=osx arch=arm64 osxcross_sdk=darwin19 CXXFLAGS="-Wno-deprecated-declarations -Wno-error " builtin_freetype=yes',
