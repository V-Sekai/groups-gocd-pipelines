            ...
            tasks: [
              {
                ...
                is_source_a_file: true,
                source: 'extension_api.json',
                destination: 'godot-cpp/godot-headers',
              },
              {
                type: 'exec',
                arguments: [
                  '-c',
                  platform_info.scons_env + 'scons werror=no platform=' + platform_info.gdextension_platform + ' target=release -j`nproc` use_lto=no deprecated=no generate_bindings=yes custom_api_file=../godot-headers/extension_api.json headers_dir=../godot-headers ' + platform_info.godot_scons_arguments,
                ],
                command: '/bin/bash',
