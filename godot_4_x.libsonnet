...
local platform_info_dict = {
  windows: {
    ...
    godot_scons_arguments: "use_mingw=yes use_llvm=yes use_lld=yes use_thinlto=yes LINKFLAGS='-Wl,--exclude-all-symbols -Wl,-pdb= CCFLAGS=\"-g -gcodeview\"' debug_symbols=no",
    extra_commands: [],
