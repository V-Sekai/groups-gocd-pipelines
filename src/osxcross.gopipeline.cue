	...
	jobs: [
		{
			...
			tasks: [
				...
				},
				{
					"arguments": [
						"-c",
						"export UNATTENDED=1 && CLANG_VERSION=16.0.0 ENABLE_CLANG_INSTALL=1 INSTALLPREFIX=target ./build_apple_clang.sh && export PATH=$PATH:target/bin && ./build.sh && ./build_compiler_rt.sh"
					],
					"command": "/bin/bash",
					"type": "exec",
					"working_directory": "o"
