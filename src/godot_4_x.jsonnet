...
local itch_fire_template = [docker_pipeline, docker_uro_pipeline, docker_gocd_agent_pipeline] + [godot_template_groups_editor, godot_cpp_pipeline] + godot_gdextension_pipelines + [godot_template_groups] + [godot_template_groups_editor_export];
      ...
      jobs: [
        {
          ...
          tasks: [
            ...
            },
            {
              ...
              arguments: [
                '-c',
                platform_info.scons_env + 'scons werror=no platform=' + platform_info.scons_platform + ' target=editor -j4 use_lto=no deprecated=no ' + platform_info.godot_scons_arguments +
      ...
      jobs: [
        {
          ...
          tasks: [
            ...
            if platform_info.editor_godot_binary == platform_info.intermediate_godot_binary then {
              ...
              arguments: [
                '-c',
                platform_info.scons_env + 'scons werror=no platform=' + platform_info.scons_platform + ' target=editor -j4 use_lto=no deprecated=no ' + platform_info.godot_scons_arguments + if godot_modules_git != '' then ' custom_modules=../godot_custom_modules' else '',
              ],
              command: '/bin/bash',
              working_directory: 'g',
            },
        ...
        jobs: [
          {
            ...
            tasks: [
              ...
              },
              {
                ...
                arguments: [
                  '-c',
                  platform_info.scons_env + 'scons werror=no platform=' + platform_info.gdextension_platform + ' target=editor debug_symbols=yes -j4 use_lto=no deprecated=no generate_bindings=yes headers_dir=../godot-headers ' + platform_info.godot_scons_arguments,
                ],
                command: '/bin/bash',
