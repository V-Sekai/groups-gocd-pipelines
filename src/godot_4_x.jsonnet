...
local enabled_engine_platforms = [platform.platform_info_dict[x] for x in ['windows', 'linux', 'linux_release', 'web_release']];
        ...
        jobs: [
          {
            ...
            tasks: [
              ...
              },
              {
                ...
                arguments: [
                  '-c',
                  platform_info.scons_env + 'scons werror=no platform=' + platform_info.gdextension_platform + ' target=editor debug_symbols=yes use_lto=no deprecated=no generate_bindings=yes headers_dir=../godot-headers ' + platform_info.godot_scons_arguments,
                ],
                command: '/bin/bash',
        ...
        jobs: [
          {
            ...
            tasks: [
            ...
            ] + [
              {
                ...
                arguments: [
                  '-c',
                  platform_info.scons_env + 'scons werror=no platform=' + platform_info.gdextension_platform + ' target=editor debug_symbols=yes use_lto=no deprecated=no ' + platform_info.godot_scons_arguments + library_info.platforms[platform_info.gdextension_platform].scons_arguments,
                ],
                command: '/bin/bash',
                working_directory: 'p',
              },
